...
namespace App\Infrastructure\ORM\migrations;
 ...
 */
final class Version20201121220901 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP SEQUENCE tax_invoice_id_seq CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE SEQUENCE tax_invoice_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
